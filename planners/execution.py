...
def execution_planner_node(state: ResearchState):
    ...
    # 1. извлекаем историю уже запущенных инструментов для защиты от циклов
    ...
    # 2. извлекаем уже накопленные факты
    current_facts = (
    ...
    # 3. извлекаем текущий план исследования если он был создан панером
